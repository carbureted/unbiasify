...
},{"process":"../node_modules/process/browser.js"}],"ui/index.js":[function(require,module,exports) {
"use strict";
...
document.addEventListener('DOMContentLoaded', function () {
  var $clearLinkedInPhotos = (0, _jquery.default)('#clear-photos');
  var $clearLinkedInNames = (0, _jquery.default)('#clear-names');
  var $clearAlPhotos = (0, _jquery.default)('#clear-al-photos');
  var $clearAlNames = (0, _jquery.default)('#clear-al-names');
  var $clearTwitterPhotos = (0, _jquery.default)('#clear-twitter-photos');
  var $clearTwitterNames = (0, _jquery.default)('#clear-twitter-names');
  var $clearReplitPhotos = (0, _jquery.default)('#clear-replit-photos');
  var $clearReplitNames = (0, _jquery.default)('#clear-replit-names');
  var $clearGreenhousePhotos = (0, _jquery.default)('#clear-greenhouse-photos');
  var $clearGreenhouseNames = (0, _jquery.default)('#clear-greenhouse-names');
  var $clearLeverNames = (0, _jquery.default)('#clear-lever-names');
  var $clearFacebookPhotos = (0, _jquery.default)('#clear-facebook-photos');
  var $clearFacebookNames = (0, _jquery.default)('#clear-facebook-names');
  var $clearGithubPhotos = (0, _jquery.default)('#clear-github-photos');
  var $clearGithubNames = (0, _jquery.default)('#clear-github-names');
  var $clearMeetupPhotos = (0, _jquery.default)('#clear-meetup-photos');
  var $clearMeetupNames = (0, _jquery.default)('#clear-meetup-names');
  ...
  (0, _jquery.default)('#actionButton').click(function () {
