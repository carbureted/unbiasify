...
},{"process":"pBGv"}],"t3yc":[function(require,module,exports) {
"use strict";var e=o(require("jquery"));function o(e){return e&&e.__esModule?e:{default:e}}document.addEventListener("DOMContentLoaded",function(){var o=(0,e.default)("#clear-photos"),t=(0,e.default)("#clear-names"),n=(0,e.default)("#clear-al-photos"),a=(0,e.default)("#clear-al-names"),c=(0,e.default)("#clear-twitter-photos"),g=(0,e.default)("#clear-twitter-names"),l=(0,e.default)("#clear-replit-photos"),f=(0,e.default)("#clear-replit-names"),s=(0,e.default)("#clear-greenhouse-photos"),u=(0,e.default)("#clear-greenhouse-names"),i=(0,e.default)("#clear-lever-names"),h=(0,e.default)("#clear-facebook-photos"),r=(0,e.default)("#clear-facebook-names"),m=(0,e.default)("#clear-github-photos"),d=(0,e.default)("#clear-github-names"),p=(0,e.default)("#clear-meetup-photos"),b=(0,e.default)("#clear-meetup-names");function N(e){chrome.tabs.query({},function(o){for(var t=0;t<o.length;t++)chrome.tabs.sendMessage(o[t].id,e)})}function P(e,o){chrome.storage.sync.get(e,function(t){t[e]?o.prop("checked",!0):o.prop("checked",!1)})}function k(e){chrome.tabs.create({url:e},function(e){setTimeout(function(){chrome.tabs.remove(e.id)},500)})}P("togglePhotos",o),P("toggleNames",t),P("toggleAlPhotos",n),P("toggleAlNames",a),P("toggleTwitterPhotos",c),P("toggleTwitterNames",g),P("toggleReplitPhotos",l),P("toggleReplitNames",f),P("toggleGreenhousePhotos",s),P("toggleGreenhouseNames",u),P("toggleLeverNames",i),P("toggleFacebookPhotos",h),P("toggleFacebookNames",r),P("toggleGithubPhotos",m),P("toggleGithubNames",d),P("toggleMeetupNames",b),P("toggleMeetupPhotos",p),o.off().on("change",function(){N({togglePhotos:!0})}),t.off().on("change",function(){N({toggleNames:!0})}),n.off().on("change",function(){N({toggleAlPhotos:!0})}),a.off().on("change",function(){N({toggleAlNames:!0})}),g.off().on("change",function(){N({toggleTwitterNames:!0})}),c.off().on("change",function(){N({toggleTwitterPhotos:!0})}),l.off().on("change",function(){N({toggleReplitPhotos:!0})}),f.off().on("change",function(){N({toggleReplitNames:!0})}),s.off().on("change",function(){N({toggleGreenhousePhotos:!0})}),u.off().on("change",function(){N({toggleGreenhouseNames:!0})}),i.off().on("change",function(){N({toggleLeverNames:!0})}),h.off().on("change",function(){N({toggleFacebookPhotos:!0})}),r.off().on("change",function(){N({toggleFacebookNames:!0})}),m.off().on("change",function(){N({toggleGithubPhotos:!0})}),d.off().on("change",function(){N({toggleGithubNames:!0})}),b.off().on("change",function(){N({toggleMeetupNames:!0})}),p.off().on("change",function(){N({toggleMeetupPhotos:!0})}),(0,e.default)("#actionButton").click(function(){switch((0,e.default)("#additional-options").val()){case"feedback":k("mailto:martin.hauck@gmail.com");break;case"additionalResource":k("https://www.thepeoplepeoplegroup.com/unbiasify");break;case"tweetUs":k("https://twitter.com/intent/tweet?text=I've been using @unbiasify to reduce my unconscious bias! You should check it out too!")}})});
},{"jquery":"juYr"}]},{},["t3yc"], null)
=======
/*!
...
},{"process":"../node_modules/process/browser.js"}],"contentScripts/utils/get-initial-val.js":[function(require,module,exports) {
"use strict";
...
var _getInitialVal = require("../contentScripts/utils/get-initial-val");
...
document.addEventListener('DOMContentLoaded', function () {
  var $toggleLinkedIn = (0, _jquery.default)('#toggle-linkedin');
  var $toggleAngelList = (0, _jquery.default)('#toggle-angellist');
  var $toggleReplit = (0, _jquery.default)('#toggle-replit');
  var $toggleGreenhouse = (0, _jquery.default)('#toggle-greenhouse');
  var $toggleLever = (0, _jquery.default)('#toggle-lever');
  var $toggleGithub = (0, _jquery.default)('#toggle-github');
  var $toggleMeetup = (0, _jquery.default)('#toggle-meetup');
  var LINKEDIN = 'linkedin';
  var TOGGLE_ANGELLIST = 'toggleAngelList';
  var TOGGLE_REPLIT = 'toggleReplit';
  var TOGGLE_GREENHOUSE = 'toggleGreenhouse';
  var LEVER = 'lever';
  var GITHUB = 'github';
  var MEETUP = 'meetup';
  ...
  $toggleLinkedIn.off().on('change', function () {
    var set = $toggleLinkedIn.is(':checked');
    chrome.storage.sync.set(_defineProperty({}, LINKEDIN, set));
    sendMessage({
      toggleLinkedin: set
    });
  });
  $toggleAngelList.off().on('change', function () {
    var set = $toggleAngelList.is(':checked');
    sendMessage({
      toggleAngelList: set
    });
  });
  $toggleReplit.off().on('change', function () {
    var set = $toggleReplit.is(':checked');
    sendMessage({
      toggleReplit: set
    });
  });
  $toggleGreenhouse.off().on('change', function () {
    var set = $toggleGreenhouse.is(':checked');
    sendMessage({
      toggleGreenhouse: set
    });
  });
  $toggleLever.off().on('change', function () {
    var set = $toggleLever.is(':checked');
    sendMessage({
      toggleLever: set
    });
  });
  $toggleGithub.off().on('change', function (e) {
    var set = $toggleGithub.is(':checked');
    chrome.storage.sync.set(_defineProperty({}, GITHUB, set));
    sendMessage({
      toggleGithub: set
    });
  });
  $toggleMeetup.off().on('change', function (e) {
    var set = $toggleGreenhouse.is(':checked');
    chrome.storage.sync.set(_defineProperty({}, MEETUP, set));
    sendMessage({
      toggleMeetup: set
    });
  });
  ...
  function setInitialValues(identifier, toggleInput) {
    (0, _getInitialVal.getInitialVal)(identifier, function (val) {
  ...
  (0, _jquery.default)('#actionButton').on('click', function () {
    var action = (0, _jquery.default)('#additional-options').val();
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","../contentScripts/utils/get-initial-val":"contentScripts/utils/get-initial-val.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ui/index.js"], null)
>>>>>>> Start of refactor
